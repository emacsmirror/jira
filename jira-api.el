...
(defun jira-api--callback-success-log (data response)
...
(cl-defun jira-api-call (verb endpoint &key params data callback)
  "Perform a request to the Jira API, calling callback if successful"
...
(cl-defun jira-api-tempo-call (verb endpoint &key params callback)
  "Perform a request to the Jira Tempo API, calling callback if successful"
...
(defun jira-api-get-transitions (issue-key)
  "Get the transitions available for an issue"
